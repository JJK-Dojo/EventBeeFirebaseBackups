    ...
    return (
        <Card key={event.id} className="flex flex-col overflow-hidden transition-shadow hover:shadow-md md:flex-row">
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-sm">
                ...
                <span className="font-semibold">{event.points || 0}</span>
...
export default function ProfilePage() {
    ...
    useEffect(() => {
        if (!isLoading && events) {
            ...
            const calculatedPoints = eventsWithStats.reduce((acc, event) => acc + (event.points || 0), 0) + 500;
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 flex items-center justify-center gap-2 sm:justify-start">
                    ...
                    <span className="text-xl font-bold text-foreground">
                      {totalPoints !== null ? totalPoints.toLocaleString() : '...'} Points
                    </span>
